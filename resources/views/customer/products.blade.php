    ...
    <div class="container" style="max-width: 1200px; margin: auto; padding: 0 20px;">
        ...
        <div style="text-align: center; margin-bottom: 50px;" class="animate__animated animate__fadeIn">
            ...
            <p style="color: #64748b; font-size: 16px;">
                Pilih produk favoritmu dan tambahkan ke keranjang belanja!
            </p>
        ...
        <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(240px, 1fr)); gap: 25px;">
            ...
            <div class="product-card animate__animated animate__fadeInUp"
                ...
                {{-- STOK --}}
                <div style="position: absolute; top: 12px; left: 12px; background: rgba(255,255,255,0.9);
                            backdrop-filter: blur(5px); color: #1e293b; padding: 4px 10px;
                            border-radius: 10px; font-size: 11px; font-weight: 700; z-index: 5;
                ...
                <div style="padding: 18px;">
                    <span style="color: #28a745; font-size: 10px; font-weight: 800;
                    ...
                    <a href="{{ route('products.show', $p->id) }}"
                       style="text-decoration:none; color:inherit;">
                        <h3 style="font-size: 16px; font-weight: 700; color: #1e293b;
                                   margin: 5px 0 12px 0; min-height: 40px; line-height: 1.4;">
                            {{ $p->nama_produk }}
                        </h3>
                    </a>
